...
df = pd.read_csv('DIS_lab_LoS_64.csv')
...
images_folder = "images_64antennas_DIS"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/DIS/64antennas/validation/"
...
folder = images_folder+"/predictions/DIS/64antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
