...
df = pd.read_csv('DIS_lab_LoS_8.csv')
...
images_folder = "images_8antennas_DIS"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/DIS/8antennas/validation/"
...
folder = images_folder+"/predictions/DIS/8antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
