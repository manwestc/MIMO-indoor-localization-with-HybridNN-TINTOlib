...
df = pd.read_csv('ULA_lab_LoS_32_100.csv')
...
images_folder = "images_32antennas_ULA"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/ULA/32antennas/validation/"
...
folder = images_folder+"/predictions/ULA/32antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
