...
df = pd.read_csv('ULA_lab_LoS_64_100.csv')
...
images_folder = "images_64antennas_ULA"
...
modelX.save(images_folder+'/modelX64.h5')
...
modelY.save(images_folder+'/modelY_64.h5')
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/ULA/64antennas/validation/"
...
folder = images_folder+"/predictions/ULA/64antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
...
results_filename = images_folder+results_folder+'evaluation_results.txt'
