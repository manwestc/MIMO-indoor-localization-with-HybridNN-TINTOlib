...
df = pd.read_csv('URA_lab_LoS_32_100.csv')
...
images_folder = "images_32antennas_URA"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/URA/32antennas/validation/"
...
folder = images_folder+"/predictions/URA/32antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
