...
df = pd.read_csv('URA_lab_LoS_16_100.csv')
...
images_folder = "images_16antennas_URA"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/URA/16antennas/validation/"
...
folder = images_folder+"/predictions/URA/16antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
