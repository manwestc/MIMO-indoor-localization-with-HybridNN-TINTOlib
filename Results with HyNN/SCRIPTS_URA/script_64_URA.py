...
df = pd.read_csv('URA_lab_LoS_64_100.csv')
...
images_folder = "images_64antennas_URA"
...
# VALIDATION RESULTS
folder = images_folder+"/predictions/URA/64antennas/validation/"
...
folder = images_folder+"/predictions/URA/64antennas/test/"
if not os.path.exists(folder):
    os.makedirs(folder)
